...
[![Release](https://img.shields.io/badge/release-0.1.3-blue.svg)](https://github.com/altairflyy/Caustica-Rework/releases/tag/rework-0.1.3)
...
[![Downloads](https://img.shields.io/github/downloads/altairflyy/Caustica-Rework/total?color=blue)](https://github.com/altairflyy/Caustica-Rework/releases/tag/rework-0.1.3)
...
> ### [Download Caustica Rework 0.1.3](https://github.com/altairflyy/Caustica-Rework/releases/tag/rework-0.1.3)
> Verified release artifact: `caustica-0.1.3.jar` &bull; [Direct JAR Download](https://github.com/altairflyy/Caustica-Rework/releases/download/rework-0.1.3/caustica-0.1.3.jar) &bull; [Installation Guide](#install)

[Download](https://github.com/altairflyy/Caustica-Rework/releases/tag/rework-0.1.3) | [Install](#install) | [Requirements](#requirements) | [Building from Source](#building-from-source) | [Known Limitations](#known-limitations) | [Architecture](#architecture) | [Changelog](CHANGELOG.md) | [Rewrite Documentation](#rewrite-documentation)
...
- [GitHub Releases (Download)](https://github.com/altairflyy/Caustica-Rework/releases/tag/rework-0.1.3)
...
3. **Download Caustica Rework**: Download `caustica-0.1.3.jar` from the [GitHub Releases](https://github.com/altairflyy/Caustica-Rework/releases/tag/rework-0.1.3) page.
4. **Place JAR**: Place `caustica-0.1.3.jar` directly into your Minecraft instance's `.minecraft/mods` directory.
...
The resulting mod JAR will be located at `build/libs/caustica-0.1.3.jar`.
