package dev.comfyfluffy.candela.rt.material;

import com.mojang.blaze3d.platform.NativeImage;
import com.mojang.blaze3d.textures.GpuTextureView;
import com.mojang.blaze3d.vulkan.VulkanGpuTextureView;
import dev.comfyfluffy.candela.CandelaMod;
import dev.comfyfluffy.candela.mixin.TextureAtlasAccessor;
...
public final class RtParallelAtlas {
    ...
    public void prepareAll() {
        ...
        try {
            ...
            sprites = ((TextureAtlasAccessor) atlas).candela$sprites();
        } catch (Throwable t) {
    ...
    public int ensure(TextureAtlasSprite sprite) {
        ...
        if (!loggedLazyFallback) {
            ...
            CandelaMod.LOGGER.info("RT material ensure() lazy-loaded sprite {} for atlas {}",
