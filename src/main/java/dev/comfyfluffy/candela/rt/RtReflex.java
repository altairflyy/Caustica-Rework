 ...
 * {@code MinecraftMixin#candela$reflexSleep}).
 *
...
public final class RtReflex {
    ...
    public static boolean enabled() {
        return CandelaConfig.Rt.Reflex.ENABLED.value() && RtDeviceBringup.reflexEnabled();
    }
    ...
    public void applySleepMode(VkDevice device, long swapchain) {
        ...
        boolean boost = CandelaConfig.Rt.Reflex.LOW_LATENCY_BOOST.value();
        int minIntervalUs = CandelaConfig.Rt.Reflex.MINIMUM_INTERVAL_US.value();
        ...
        try {
            ...
            CandelaMod.LOGGER.info("Reflex: sleep mode applied (boost={}, minIntervalUs={})", boost, minIntervalUs);
        } catch (Throwable t) {
            failed = true;
            CandelaMod.LOGGER.error("Reflex: applySleepMode failed; Reflex disabled for session", t);
        }
    }
    ...
    public void sleep(VkDevice device, long swapchain) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if (r != VK10.VK_SUCCESS) {
                ...
                CandelaMod.LOGGER.warn("Reflex: vkWaitSemaphores({}) returned {}; pacing skipped this frame",
                        counter, r);
            }
        } catch (Throwable t) {
            failed = true;
            CandelaMod.LOGGER.error("Reflex: sleep failed; Reflex disabled for session", t);
        }
    }
    ...
    public void marker(VkDevice device, long swapchain, int marker, long id) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            CandelaMod.LOGGER.warn("Reflex: vkSetLatencyMarkerNV({}) threw; ignoring", marker, t);
        }
    }
