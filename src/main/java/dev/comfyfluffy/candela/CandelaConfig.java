 ...
 * {@code -Dcandela.*} system property, then the {@code config/candela.toml} file, then a hardcoded
 ...
 *
 * <p>The system property namespace ({@code candela.rt.foo}) and the TOML layout are independent: the file
...
public final class CandelaConfig {
    ...
    private static void writeComments() {
        FILE.setComment("enabled",
                " Candela RT renderer configuration.\n"
                        + " A matching -Dcandela.* system property overrides the value below.");
    ...
    private static Path resolveConfigPath() {
        try {
            return FabricLoader.getInstance().getConfigDir().resolve("candela.toml");
        } catch (Throwable t) {
            return Path.of("config", "candela.toml");
        }
    }
    ...
    private static CommentedFileConfig loadFile(Path path) {
        ...
        try {
            ...
            LOGGER.warn("Failed to read Candela config {}: {}", path, e.toString());
        }
        return config;
    }
    ...
    public interface RuntimeSetting<T> {
        /** The {@code -Dcandela.*} system property name that overrides this setting. */
        String key();

        /** The dotted path of this setting inside the nested {@code config/candela.toml} tables. */
        String tomlPath();
    ...
    public static final class Rt {
        public static final BooleanSetting ENABLED = bool("candela.rt", "enabled", true);
        public static final IntSetting WORKER_THREADS =
                intAtLeast("candela.rt.workerThreads", "worker-threads", defaultWorkerThreads(), 1);

        private Rt() {
        }

        public static final class Composite {
            public static final IntSetting DEBUG_VIEW = intValue("candela.rt.debugView", "composite.debug-view", 0);
            public static final IntSetting SPP = intAtLeast("candela.rt.spp", "composite.spp", 1, 1);
            public static final IntSetting MAX_BOUNCES =
                    clampedInt("candela.rt.maxBounces", "composite.max-bounces", 4, 2, 8);
            public static final BooleanSetting WATER_WAVES =
                    bool("candela.rt.waterWaves", "composite.water-waves", true);
            public static final FloatSetting SUN_ANGULAR_RADIUS =
                    radians("candela.rt.sunAngularRadius", "composite.sun-angular-radius-deg", 0.6f);
            public static final FloatSetting MOON_ANGULAR_RADIUS =
                    radians("candela.rt.moonAngularRadius", "composite.moon-angular-radius-deg", 1.5f);
            public static final FloatSetting SUN_NOON_SOUTH_TILT =
                    radians("candela.rt.sunNoonSouthDeg", "composite.sun-noon-south-tilt-deg", 30.0f);
            public static final FloatSetting JITTER_SIGN_X =
                    finiteFloat("candela.rt.jitterSignX", "composite.jitter-sign-x", 1.0f);
            public static final FloatSetting JITTER_SIGN_Y =
                    finiteFloat("candela.rt.jitterSignY", "composite.jitter-sign-y", -1.0f);
        ...
        public static final class Terrain {
            public static final IntSetting ASYNC_DISPATCH_PER_TICK =
                    intAtLeast("candela.rt.asyncDispatchPerTick", "terrain.async-dispatch-per-tick", 64, 0);
            public static final IntSetting SECTION_RESULTS_PER_TICK =
                    intAtLeast("candela.rt.sectionResultsPerTick", "terrain.section-results-per-tick", 64, 0);
            public static final FloatSetting STREAM_BUDGET_MS =
                    clampedFloat("candela.rt.streamBudgetMs", "terrain.stream-budget-ms", 1.5f, 0.05f, 100f);
            public static final FloatSetting STREAM_BUDGET_MAX_MS =
                    clampedFloat("candela.rt.streamBudgetMaxMs", "terrain.stream-budget-max-ms", 6f, 0.05f, 100f);
            public static final FloatSetting STREAM_FALLBACK_BUDGET_MS =
                    clampedFloat("candela.rt.streamFallbackBudgetMs", "terrain.stream-fallback-budget-ms", 8f, 0.05f, 100f);
            public static final IntSetting MAX_INFLIGHT_SECTIONS =
                    intAtLeast("candela.rt.maxInflightSections", "terrain.max-inflight-sections", 192, 0);
            public static final IntSetting SECTION_TABLE_INITIAL_CAPACITY =
                    intAtLeast("candela.rt.sectionTableInitialCapacity", "terrain.section-table-initial-capacity", 512, 1);
            public static final IntSetting REBASE_DISTANCE_BLOCKS =
                    intAtLeast("candela.rt.rebaseDistanceBlocks", "terrain.rebase-distance-blocks", 128, 0);
        ...
        public static final class Omm {
            public static final BooleanSetting ENABLED = bool("candela.rt.omm", "omm.enabled", true);
            public static final IntSetting SUBDIVISION =
                    clampedInt("candela.rt.ommSubdivision", "omm.subdivision", 4, 0, 12);
            public static final BooleanSetting STATS = bool("candela.rt.ommStats", "omm.stats", false);
        ...
        public static final class Entities {
            public static final BooleanSetting ENABLED = bool("candela.rt.entities", "entities.enabled", true);
            public static final BooleanSetting PARTICLES_ENABLED =
                    bool("candela.rt.particles", "particles.enabled", true);
            public static final BooleanSetting GLOW_ENABLED =
                    bool("candela.rt.glow", "entities.glow.enabled", true);
            public static final BooleanSetting NAME_TAGS_ENABLED =
                    bool("candela.rt.nameTags", "entities.name-tags.enabled", true);
            public static final IntSetting MAX_ENTITIES =
                    intAtLeast("candela.rt.maxEntities", "entities.max-entities", 1024, 1);
            public static final IntSetting BE_VIEW_CHUNKS =
                    intAtLeast("candela.rt.beViewChunks", "entities.block-entities.view-chunks", 8, 0);
            public static final IntSetting BE_BUILDS_PER_FRAME =
                    intAtLeast("candela.rt.beBuildsPerFrame", "entities.block-entities.builds-per-frame", 8, 0);
            public static final IntSetting REFIT_REBUILD_INTERVAL =
                    intAtLeast("candela.rt.refitRebuildInterval", "entities.refit.rebuild-interval", 120, 1);
        ...
        public static final class EntityTextures {
            public static final IntSetting MAX_TEXTURES =
                    intAtLeast("candela.rt.maxEntityTextures", "entities.textures.max-textures", 256, 1);
            public static final BooleanSetting PBR = bool("candela.rt.entityPbr", "entities.textures.pbr", true);
        ...
        public static final class Overlay {
            public static final BooleanSetting BLOCK_OUTLINE_ENABLED =
                    bool("candela.rt.blockOutline", "overlay.block-outline.enabled", true);
        ...
        public static final class DlssRr {
            public static final BooleanSetting ENABLED = bool("candela.rt.dlssRr", "dlss-rr.enabled", true);
            public static final IntSetting PRESET = intValue("candela.rt.dlssRr.preset", "dlss-rr.preset", 0);
            public static final IntSetting QUALITY = intValue("candela.rt.dlssRr.quality", "dlss-rr.quality", 0);
        ...
        public static final class Fg {
            public static final BooleanSetting ENABLED = bool("candela.rt.fg", "frame-generation.enabled", false);
            public static final IntSetting MULTI_FRAME_COUNT =
                    intAtLeast("candela.rt.fg.multiFrameCount", "frame-generation.multi-frame-count", 1, 1);
        ...
        public static final class Reflex {
            public static final BooleanSetting ENABLED = bool("candela.rt.reflex", "reflex.enabled", false);
            public static final BooleanSetting LOW_LATENCY_BOOST =
                    bool("candela.rt.reflex.boost", "reflex.low-latency-boost", false);
            public static final IntSetting MINIMUM_INTERVAL_US =
                    intAtLeast("candela.rt.reflex.minIntervalUs", "reflex.minimum-interval-us", 0, 0);
        ...
        public static final class Exposure {
            public static final StringSetting MODE =
                    string("candela.rt.exposure.mode", "exposure.mode", "auto", Exposure::sanitizeMode);
            public static final FloatSetting MANUAL_EV =
                    finiteFloat("candela.rt.exposure.manualEv", "exposure.manual-ev", 0.0f);
            public static final FloatSetting KEY = exposureScale("candela.rt.exposure.key", "exposure.key", 0.18f);
            public static final FloatSetting MIN_EV =
                    finiteFloat("candela.rt.exposure.minEv", "exposure.min-ev", -1.5f);
            public static final FloatSetting MAX_EV =
                    finiteFloat("candela.rt.exposure.maxEv", "exposure.max-ev", 2.0f);
            public static final FloatSetting ADAPT_UP =
                    exposureScale("candela.rt.exposure.adaptUp", "exposure.adapt-up", 0.12f);
            public static final FloatSetting ADAPT_DOWN =
                    exposureScale("candela.rt.exposure.adaptDown", "exposure.adapt-down", 0.35f);
        ...
        public static final class BufferPool {
            public static final BooleanSetting STATS = bool("candela.rt.poolStats", "buffer-pool.stats", false);
        ...
        public static final class FrameStats {
            public static final BooleanSetting ENABLED = bool("candela.rt.frameStats", "frame-stats.enabled", false);
        ...
        public static final class Hdr {
            public static final BooleanSetting ENABLED = bool("candela.rt.hdr", "hdr.enabled", false);
            public static final FloatSetting PAPER_WHITE_NITS =
                    clampedFloat("candela.rt.hdr.paperWhiteNits", "hdr.paper-white-nits", 200.0f, 80.0f, 500.0f);
            public static final FloatSetting PEAK_NITS =
                    clampedFloat("candela.rt.hdr.peakNits", "hdr.peak-nits", 1000.0f, 80.0f, 5000.0f);
    ...
    public static final class Ngx {
        public static final OptionalStringSetting PATH = optionalString("candela.ngx.path", "ngx.path");
