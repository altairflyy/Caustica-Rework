 ...
 * {@link dev.comfyfluffy.candela.rt.RtComposite} reads the per-frame offset, applies it to the primary ray in the
 * path-tracing shader, and reports it to DLSS-RR's evaluate.
 */
public final class CandelaJitter {
	public static final CandelaJitter INSTANCE = new CandelaJitter();

	private int frameIndex;
	private float pixelsX;
	private float pixelsY;

	private CandelaJitter() {
	}
